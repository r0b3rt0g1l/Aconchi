    ...
    >
      ...
      >
        ...
        <p className="mt-5 max-w-xl text-base text-white/85 lg:text-lg">
          En los paredones del Río Sonora: pueblo ópata y misión jesuita del
          siglo XVII, corazón de la Ruta del Río Sonora.
        </p>
      </motion.div>
    </div>
  );
            ...
            >
              ...
              <div className="mt-3 space-y-3 font-serif text-[15px] leading-snug text-white lg:text-base">
                <p className="first-letter:float-left first-letter:mr-3 first-letter:mt-1 first-letter:font-display first-letter:text-6xl first-letter:font-bold first-letter:leading-[0.85] first-letter:text-[var(--color-dorado)]">
                  Aconchi toma su nombre del vocablo ópata Acǒtzi, que significa
                  “en los paredones”, en referencia a los imponentes acantilados
                  de roca que bordean el Río Sonora a su paso por este territorio.
                  El pueblo fue habitado desde tiempos prehispánicos por el grupo
                  étnico de los ópatas, señores de la sierra y el río.
                </p>
                <p>
                  En 1639, el misionero jesuita de origen portugués Bartolomé
                  Castaño fundó aquí la misión de San Pedro de Aconchi,
                  perteneciente al rectorado jesuita de San Francisco Javier. La
                  misión tuvo como pueblo de visita a Nuestra Señora de la
                  Concepción de Baviácora, uniendo así a dos de los pueblos más
                  antiguos de la Ruta del Río Sonora.
                </p>
                <p>
                  A lo largo del siglo XX, Aconchi experimentó los vaivenes de la
                  reorganización territorial: fue suprimido como municipio en 1930
                  e incorporado a Arizpe, luego a Baviácora en 1931, hasta que el
                  13 de abril de 1932 fue rehabilitado definitivamente como
                  municipio libre e independiente. Hoy destaca por sus aguas
                  termales medicinales en El Agua Caliente y su templo franciscano
                  de San Pedro y San Pablo, orgullo de la Ruta del Río Sonora.
                </p>
              </div>
            </motion.article>
