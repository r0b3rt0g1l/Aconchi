    ...
    <main className="flex flex-1 flex-col">
      ...
      <BannerHero
        ...
        fallback={{
          ...
          descripcion:
            "Patrimonio colonial de la época de la misión, aguas termales medicinales y naturaleza del Río Sonora. Aconchi forma parte de la Ruta del Río Sonora.",
          imagenUrl: null,
          activo: true,
        }}
      />
          ...
          <div className="rounded-2xl border border-[var(--color-border)] bg-white p-6 shadow-[var(--shadow-card)] md:p-8">
            ...
            gastronomia.dulces.length === 0 ? (
              <p className="mt-6 text-sm leading-relaxed text-[var(--color-text-secondary)]">
                Aconchi forma parte de la Ruta del Río Sonora. El catálogo de
                platillos y dulces típicos del municipio está en preparación.
              </p>
            ) : (
